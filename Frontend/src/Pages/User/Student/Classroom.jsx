...
const Classroom = () => {
    ...
    const userSubmissions = [
        ...
        ...submissions.map((submission) => {
            const matchedExam = exams.find((exam) => {
                const match = String(exam.id) === String(submission.exam);
                return match;
            });
            return {
                ...submission,
        ...
        const matches = studentIdentifier === user?.username;
        return matches;
    });
    ...
    return (
        <>
            <Navbar />
            <div className="min-h-screen bg-gray-100 px-2 sm:px-4 lg:px-6 pt-16 sm:pt-20 md:pt-16">
                {/* Breadcrumb */}
